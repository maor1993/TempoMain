...
/*setup bytes*/
static const uint8_t nSetup_bytes [] = {
		0x00,0xAE,
		0x00,0x20,
		0x00,0x10,
		0x00,0xB0,
...
void copy_to_lcd(uint8_t* data_to_copy)
{
	memcpy(SSD1306_Buffer,data_to_copy,1024);
}
